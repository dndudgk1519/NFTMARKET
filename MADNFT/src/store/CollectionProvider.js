...
import CollectionCtx from './collection-context';
...
const CollectionProvider = props => {
  ...
  const loadContractHandler = (abi, address) => {
    const contract = address ? new ethers.Contract(abi, address) : '';
  ...
  return (
    <CollectionCtx.Provider value={collectionContext}>
      {props.children}
